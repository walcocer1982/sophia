...
repository:
  ...
  url: ""
generated:
  timestamp: 2025-08-19T02:23:55.631Z
  tool: FlatRepo
statistics:
  totalFiles: 57
  totalLines: 5162
...
export const DEFAULT_TEACHER_PROFILE = {
  ...
  eval: { values: { EMPTY: 0, PARTIAL: 1, ACCEPT: 2 }, suffixHelp: true }
} as const;
...
===  .data\history\plan-test-1.jsonl
```
{"ts":1755568484551,"planUrl":"/courses/SSO001/lessons/lesson02.json","stepIdx":3,"momentIdx":0,"message":"¡Hola! En esta sesión, vamos a hablar sobre los procedimientos de seguridad, que son las pautas que debemos seguir para garantizar un ambiente laboral seguro. Es fundamental entender su importancia, ya que nos ayudan a prevenir accidentes y a proteger tanto nuestra salud como la de nuestros compañeros.","followUp":"¿Qué esperas aprender sobre procedimientos de seguridad en esta sesión?"}
{"ts":1755568514008,"planUrl":"/courses/SSO001/lessons/lesson02.json","stepIdx":3,"momentIdx":0,"message":"Es normal no tener claro qué esperar a veces. Los procedimientos de seguridad son esenciales para prevenir accidentes en el trabajo.","followUp":"¿Qué aspectos de la seguridad te interesan más?"}
{"ts":1755568541225,"planUrl":"/courses/SSO001/lessons/lesson02.json","stepIdx":3,"momentIdx":0,"message":"Los procedimientos de seguridad son un conjunto de pautas diseñadas para crear un entorno laboral seguro y prevenir accidentes. Es esencial conocer quiénes son los responsables de implementarlos y qué recursos se necesitan para su correcta aplicación. A lo largo de esta sesión, exploraremos su importancia y cómo se aplican en diferentes situaciones laborales.","followUp":"¿Qué esperas aprender sobre procedimientos de seguridad en esta sesión?"}
{"ts":1755568595105,"planUrl":"/courses/SSO001/lessons/lesson02.json","stepIdx":3,"momentIdx":0,"message":"Los procedimientos de seguridad son directrices que establecen cómo debemos actuar en el entorno laboral para evitar riesgos y accidentes. Es crucial entender quiénes son los encargados de aplicarlos y qué recursos se requieren para su implementación efectiva. Durante esta sesión, profundizaremos en su relevancia y en cómo se llevan a cabo en diversas situaciones laborales.","followUp":"¿Qué esperas aprender sobre procedimientos de seguridad en esta sesión?"}
```
=== EOF: .data\history\plan-test-1.jsonl

===  .data\history\plan-1755550979458-whrg85ng.jsonl
```
{"ts":1755569473954,"planUrl":"/courses/SSO001/lessons/lesson02.json","stepIdx":3,"momentIdx":0,"message":"Hola, bienvenido. En esta sesión, vamos a hablar sobre los procedimientos de seguridad, que son pautas esenciales para garantizar un entorno laboral seguro. Comprenderemos por qué son tan importantes y cómo pueden protegernos en el trabajo.","followUp":"¿Qué esperas aprender sobre procedimientos de seguridad en esta sesión?"}
{"ts":1755569530315,"planUrl":"/courses/SSO001/lessons/lesson02.json","stepIdx":3,"momentIdx":0,"message":"Es fundamental conocer las partes de un procedimiento de seguridad para aplicarlas correctamente en el trabajo.","followUp":"¿Qué partes crees que son esenciales?"}
```
=== EOF: .data\history\plan-1755550979458-whrg85ng.jsonl

===  .data\history\plan-1755532890808-2mpn7beq.jsonl
```
{"ts":1755547601655,"planUrl":"/courses/SSO001/lessons/lesson02.json","stepIdx":3,"momentIdx":0,"message":"Hola, bienvenido a la sesión. Hoy vamos a hablar sobre los procedimientos de seguridad, que son esenciales para garantizar un ambiente de trabajo seguro. Veremos por qué son importantes y cómo pueden ayudarnos a prevenir accidentes y proteger a todos en el lugar de trabajo.","followUp":"¿Qué esperas aprender sobre procedimientos de seguridad en esta sesión?"}
```
=== EOF: .data\history\plan-1755532890808-2mpn7beq.jsonl

===  .data\history\plan-1755526234947-rojaqbok.jsonl
```
{"ts":1755528425739,"planUrl":"/courses/SSO001/lessons/lesson02.json","stepIdx":3,"momentIdx":0,"message":"¡Hola! En esta sesión, vamos a hablar sobre los procedimientos de seguridad y por qué son tan importantes en el entorno laboral. Estos procedimientos nos ayudan a prevenir accidentes y a garantizar un ambiente de trabajo seguro para todos.","followUp":"¿Qué esperas aprender sobre procedimientos de seguridad en esta sesión?"}
{"ts":1755528434614,"planUrl":"/courses/SSO001/lessons/lesson02.json","stepIdx":3,"momentIdx":0,"message":"Piensa en los puntos clave. Comparte tus ideas en al menos 16 palabras. Guíate p","followUp":"En 16-24 palabras, cuéntame tus ideas principales sobre \"Elicitar expectativas del estudiante\"."}
```
=== EOF: .data\history\plan-1755526234947-rojaqbok.jsonl

===  .data\history\plan-1755488979318-vficrijj.jsonl
```
{"ts":1755492445742,"planUrl":"/courses/SSO001/lessons/lesson02.json","stepIdx":3,"momentIdx":0,"message":"Hola, bienvenido. En esta sesión, vamos a hablar sobre los procedimientos de seguridad, que son las pautas que se deben seguir para garantizar un ambiente laboral seguro. Es fundamental entender su importancia, ya que ayudan a prevenir accidentes y proteger a todos en el trabajo.","followUp":"¿Qué esperas aprender sobre procedimientos de seguridad en esta sesión?"}
```
=== EOF: .data\history\plan-1755488979318-vficrijj.jsonl

===  .data\history\plan-1755442012156-hap7hutj.jsonl
```
{"ts":1755486402959,"planUrl":"/courses/SSO001/lessons/lesson02.json","stepIdx":3,"momentIdx":0,"message":"Bienvenido a la sesión. Hoy vamos a hablar sobre los procedimientos de seguridad, que son esenciales para mantener un ambiente laboral seguro. Entenderemos su importancia y cómo aplicarlos en nuestra rutina diaria para prevenir riesgos.","followUp":"¿Qué esperas aprender sobre procedimientos de seguridad en esta sesión?"}
{"ts":1755486409736,"planUrl":"/courses/SSO001/lessons/lesson02.json","stepIdx":3,"momentIdx":0,"message":"Es normal no tener claridad al inicio, así que no te preocupes. En esta sesión, exploraremos las diferentes partes de los procedimientos de seguridad y su relevancia en el entorno laboral. Comprender cómo se aplican y por qué es crucial seguirlos te ayudará a mantener un ambiente seguro.\n\nEs fundamental conocer las partes de un procedimiento de seguridad para aplicarlo correctamente y prevenir riesgos en el trabajo.","followUp":"¿Cuáles crees que son esas partes?"}
{"ts":1755486419851,"planUrl":"/courses/SSO001/lessons/lesson02.json","stepIdx":3,"momentIdx":0,"message":"Es interesante ver tu interés en los procedimientos de seguridad. Conocer sus partes es clave para aplicarlos de manera efectiva y así prevenir cualquier riesgo en el entorno laboral.\n\n¿Qué esperas aprender sobre procedimientos de seguridad en esta sesión?","followUp":""}
```
  ...
  "hints": {
    ...
    "templates": {
      ...
      "reask": {
        ...
        "choice": "Indica en {maxWords} palabras la opción que aplica sobre {base}."
      },
      "open": {
        "hint": "Comparte tus ideas en al menos {minWords} palabras. {cuesLine} Conecta con tu experiencia.",
        "reask": "En {minWords}-{maxWords} palabras, cuéntame {aspects} sobre \"{objective}\".",
        "fallbackAspects": [
          "objetivo",
          "alcance",
          "responsables",
  ...
  "moments": [
    {
      ...
      "steps": [
        ...
        { "code": "M1-Q01", "order": 4, "type": "ASK",
          ...
          "acceptable_answers": ["partes del procedimiento", "cómo se aplica", "importancia de seguirlos", "selección de EPP", "objetivo", "alcance", "responsables", "recursos", "pasos", "criterios"],
...
import { shouldForceAdvance } from '@/engine/advance';
...
export async function POST(req: Request) {
    ...
    (state as any).teacherProfile = teacherProfile;
		...
		if (isStudentAskingQuestion(pendingInput, (state as any).teacherProfile) && !/\w+\?/.test(pendingInput)) {
    ...
    let skipGuarantee = false;
        ...
        if (act.kind === 'ask') {
          ...
          if (isOpen) {
            ...
            const acceptablesForOpen = (Array.isArray(acceptable) && acceptable.length) ? acceptable : (expected || []);
            const { matched: openMatched, missing: openMissing } = computeMatchedMissing(text, acceptablesForOpen, expected, { maxEditDistance: 1, similarityMin: 0.25 });
            // 2) ON_TOPIC / VAGUE / OFF_TOPIC con detectTopicDeviation
            const deviation = detectTopicDeviation(text, act.step, objText);

            // Aceptar si hay al menos una señal (sin exigir longitud ni intentos)
            ...
            if (!text || (deviation === 'OFF_TOPIC' && openMatched.length === 0) || (tooShort && attempts < 1 && openMatched.length === 0)) {
              ...
              try {
                const recent = await getRecentHistory(sessionKey, 4);
                // Avance forzado si supera el umbral del perfil (tercer 0 por defecto)
                if (shouldForceAdvance({ attempts: attemptsSoFarOpen + 1, teacherProfile: (state as any).teacherProfile })) {
                  const faltos = (openMissing && openMissing.length ? openMissing.slice(0,2) : (expected || []).slice(0,2));
                  (state as any).partiallyAnsweredAskCodes = Array.from(new Set([...((state as any).partiallyAnsweredAskCodes || []), stepCode]));
                  ...
                  message = `Avanzamos para mantener el ritmo. Tomo nota: faltó ${faltos.join(', ')}.`;
                  followUp = '';
                  state.justAskedFollowUp = false; state.lastFollowUpText = '';
                  state = next(state);
                  return NextResponse.json({ message, followUp, state, value: '0' + 'A'.repeat(hintsUsed) });
                }
                ...
                message = '';
                // Repregunta corta desde plantillas del perfil
                const reaskMsg = makeReaskMessage({ questionText: q, objective: objText, expected, answerType: (act.step.data as any)?.answer_type || 'list', teacherProfile: (state as any).teacherProfile });
                followUp = reaskMsg;
              }
              ...
              // Evaluación ligera para abiertas: aceptar si hay señales suficientes; si no, retroalimentar y re‑preguntar
            ...
            // 3) Conversación con evaluación ligera para abiertas: aceptar si hay señales suficientes; si no, retroalimentar y re‑preguntar
            {
              ...
              if (acceptOpen) {
                ...
                // re‑preguntar variando con plantilla
                const reaskMsg = makeReaskMessage({ questionText: q, objective: objText, expected, answerType: (act.step.data as any)?.answer_type || 'list', teacherProfile: (state as any).teacherProfile });
                followUp = reaskMsg;
