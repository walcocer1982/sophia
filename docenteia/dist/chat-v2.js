...
const { VectorStoreExtractor } = require('../lib/VectorStoreExtractor');
const { Course, Session } = require('../types');
...
async function processStudentMessage(message) {
    ...
    try {
        ...
        const respuesta = await conversationState.vectorStoreExtractor.handleStudent(conversationState.currentSessionKey, message);
        // Actualizar estado de la conversación
