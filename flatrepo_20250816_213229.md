...
repository:
  ...
  url: ""
generated:
  timestamp: 2025-08-17T02:32:29.899Z
  tool: FlatRepo
statistics:
  totalFiles: 44
  totalLines: 2828
...
```
{"ts":1755396693734,"planUrl":"/courses/SSO001/lessons/lesson02.json","stepIdx":3,"momentIdx":0,"message":"Bienvenido a la sesión. Hoy nos enfocaremos en los procedimientos de seguridad, que son fundamentales para garantizar un ambiente laboral seguro. Discutiremos su importancia y cómo su correcta implementación puede prevenir accidentes y proteger a todos en el trabajo.","followUp":"¿Qué esperas aprender sobre procedimientos de seguridad en esta sesión?"}
{"ts":1755396702678,"planUrl":"/courses/SSO001/lessons/lesson02.json","stepIdx":3,"momentIdx":0,"message":"Aún no es claro. Intenta mencionar: partes del procedimiento, cómo se aplica, importancia de seguirlos.\n\nEs normal no tener claridad en este tema al principio, así que no te preocupes. En esta sesión, exploraremos las diferentes partes de los procedimientos de seguridad y su relevancia en el entorno laboral. Esto te ayudará a entender cómo se aplican y por qué es crucial seguirlos para mantener un ambiente seguro.\n\nLos procedimientos de seguridad son esenciales para prevenir accidentes y asegurar un ambiente laboral adecuado.","followUp":"¿Qué partes crees que son clave en un procedimiento?"}
{"ts":1755396724973,"planUrl":"/courses/SSO001/lessons/lesson02.json","stepIdx":3,"momentIdx":0,"message":"Aún no es claro. Intenta mencionar: partes del procedimiento, cómo se aplica, importancia de seguirlos.\n\nEs completamente normal no tener claridad sobre este tema al inicio, así que sigue adelante. Para profundizar, podrías pensar en las diferentes partes que componen un procedimiento de seguridad, como las instrucciones específicas y las medidas preventivas. Esto te ayudará a entender cómo se aplican en situaciones reales y la importancia de seguirlos para evitar riesgos en el trabajo.\n\nEntiendo que no tengas claridad aún, y está bien. En esta sesión, nos enfocaremos en las partes de los procedimientos de seguridad, su aplicación y su importancia.\n\nAhora, ¿puedes elegir una de las opciones que te mencioné: las partes del procedimiento, cómo se aplica o la importancia de seguirlos? Formula tu elección de manera clara y breve.","followUp":""}
{"ts":1755396782458,"planUrl":"/courses/SSO001/lessons/lesson02.json","stepIdx":5,"momentIdx":1,"message":"Bien: mencionaste importancia de seguirlos.\n\nEs genial que ya reconozcas la importancia de seguir los procedimientos de seguridad, ya que esto es fundamental para mantener un entorno laboral seguro. Ahora, sería útil que también consideres las diferentes partes de un procedimiento y cómo se aplican en la práctica. En nuestra sesión, exploraremos estos aspectos para que tengas una comprensión más completa.\n\nEs normal no tener claridad al principio sobre los procedimientos de seguridad, y eso está bien. En esta sesión, nos centraremos en entender las partes que componen estos procedimientos, cómo se aplican y por qué es vital seguirlos para asegurar un entorno laboral seguro.\n\nEn una obra de construcción, un trabajador que debe instalar ventanas en el tercer piso recibe un arnés de seguridad. Sin embargo, como no tiene experiencia trabajando en altura, es crucial que reciba instrucciones claras sobre cómo usar el equipo y seguir los procedimientos de seguridad. Esto es fundamental para prevenir accidentes y garantizar su protección mientras realiza la tarea.","followUp":"¿Qué elementos de seguridad identificas en esta situación?"}
{"ts":1755396794692,"planUrl":"/courses/SSO001/lessons/lesson02.json","stepIdx":5,"momentIdx":1,"message":"Aún no es claro. Intenta mencionar: arnés, arnés de seguridad, línea.\n\nEs muy bueno que hayas identificado el arnés como un elemento de seguridad. Recuerda que también es importante considerar el arnés de seguridad y la línea de vida, que son esenciales para proteger al trabajador en alturas. Sigue explorando estos conceptos, ya que son clave para entender cómo se aplican los procedimientos de seguridad en situaciones laborales.\n\nEn una obra de construcción, el uso del arnés de seguridad es fundamental para proteger al trabajador que trabaja en altura. También es importante contar con una línea de seguridad que lo sujete adecuadamente.","followUp":"¿Qué más crees que se necesita para trabajar seguro?"}
```
...
import { classifyTurn, isVagueAnswer, type AskPolicy } from '@/engine/eval';
